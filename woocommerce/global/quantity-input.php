...
?>
<div class="max-w-[8vw] lg:max-w-[4vw] mt-2">
	...
	<div class="quantity flex h-[55px] w-[140px] px-[15px] bg-white items-center justify-between rounded-[15px]">
		...
		<div class="quantity-decrease h-3 w-3 bg-transparent border-[1px] border-[#fff] bg-white flex justify-center items-center">
			<svg xmlns="http://www.w3.org/2000/svg" width="12" height="1" viewBox="0 0 12 1">
				<line id="Line_191" data-name="Line 191" x1="12" transform="translate(0 0.5)" fill="none" stroke="#171717" stroke-width="1"/>
			</svg>
		</div>
		<input
			...
			class="border-t-[1px] border-b-[1px] border-[#fff] h-3 w-3 font-satoshi text-18 font-bold flex justify-center items-center text-center rounded-none"
			...
			<?php endif; ?>
		/>
		<div class="quantity-increase h-3 w-3 bg-transparent border-[1px] border-[#fff] bg-white flex justify-center items-center">
			<svg xmlns="http://www.w3.org/2000/svg" width="12" height="11.4" viewBox="0 0 12 11.4">
				<g id="Group_1099" data-name="Group 1099" transform="translate(-1131.5 -706.5)">
					<line id="Line_190" data-name="Line 190" y2="11.4" transform="translate(1137.5 706.5)" fill="none" stroke="#171717" stroke-width="1"/>
					<line id="Line_191" data-name="Line 191" x1="12" transform="translate(1131.5 712.2)" fill="none" stroke="#171717" stroke-width="1"/>
				</g>
			</svg>
		</div>
		<?php
