...
3641 SK Mijdrecht
        ...
        <section class="bg-[#012F8C] daysix-afrekenen py-[15vw] md:py-[7vw] relative">
            ...
            <a href="https://druksdeal.nl/retour/" class="text-white text-12 leading-12 font-satoshi">Terugbetaal- en retourneringsbeleid</a>
        </div>
        </section>
    </div>
