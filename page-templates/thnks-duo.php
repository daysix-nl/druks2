    ...
    <section class="bg-[#012F8C] relative min-h-[100dvh] overflow-hidden flex items-center justify-center">
        <div class="pb-[60px]">
            <div class="container relative z-[99] mb-3">
                <h1 class="text-[11vw] leading-[11vw] md:text-[5.7vw] md:leading-[6.7vw] text-white uppercase font-bison text-center">Bedankt voor je aankoop. Het hoofdstuk verschijnt binnen enkele minuten in je digitale postvak.</h1>
            </div>
